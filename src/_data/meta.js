...
export const author = {
  name: 'Lensa', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: 'email@email.com', // i.e. hola@lenesaile.com - email of the author
  website: 'https://www.website.com' // i.e. https.://www.lenesaile.com - the personal site of the author
};
export const creator = {
  name: 'Rustie', // i.e. - creator's (developer) name.
  email: '',
  website: 'https://www.rusticola.co.uk',
  social: 'https://hachyderm.io/@rusticola'
};
